...
const apply = () => {
  ...
  if (transactionDate.value && transactionDate.value.length > 0) {
    const start = transactionDate.value[0]
      ? new Date(transactionDate.value[0])
      : null;
    const end = transactionDate.value[1]
      ? new Date(transactionDate.value[1])
      : new Date(transactionDate.value[0]);
