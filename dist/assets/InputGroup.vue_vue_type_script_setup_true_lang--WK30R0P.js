...
`,D={root:"p-inputgroup"},A=$.extend({name:"inputgroup",style:O,classes:D}),q={name:"BaseInputGroup",extends:m,style:A,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},b={name:"InputGroup",extends:q,inheritAttrs:!1};function H(t,n,e,i,o,r){return p(),a("div",s({class:t.cx("root")},t.ptmi("root")),[l(t.$slots,"default")],16)}b.render=H;const J={key:0,class:"flex flex-col items-start justify-start relative gap-1 w-full shrink-0 overflow-hidden"},K={key:0,class:"text-[10px] font-normal leading-4"},U=h({__name:"FieldWrapper",props:{label:{},mandatory:{type:Boolean},optional:{type:Boolean,default:void 0},labelClass:{}},setup(t){const n=t,e=g(()=>["text-xs flex gap-[2px] tracking-[0.02em]",n.labelClass]);return(i,o)=>i.$attrs["use-wrapp"]!=!1?(p(),a("div",J,[i.label?(p(),a("span",{key:0,class:v(e.value)},[y(F(i.label)+" ",1),i.mandatory==!1&&i.optional?(p(),a("span",K," (Opsional) ")):f("",!0)],2)):f("",!0),l(i.$slots,"default")])):l(i.$slots,"default",{key:1})}}),W=h({__name:"InputGroup",props:{disabled:{type:Boolean},class:{}},setup(t){const n=t,e=g(()=>["[&_.inputgroupslot[slot-addon-variant=plain]]:!ring-[0px]","[&:has(input)]:!cursor-text","!h-[30px]","flex items-stretch","w-full","bg-white",n.class]),i=o=>{const r=o.target;if(r){const d=r.querySelector("input");d==null||d.focus()}};return(o,r)=>o.$attrs["use-input-group"]!=!1?(p(),w(_(b),{key:0,onClick:i,class:v(e.value)},{default:k(()=>[l(o.$slots,"default")]),_:3},8,["class"])):l(o.$slots,"default",{key:1})}});export{W as _,U as a,j as b,V as c,C as s};
